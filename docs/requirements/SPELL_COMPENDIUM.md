# Spell Compendium — First Pass

## Document Status: FIRST DRAFT
**Last Updated:** 2026-03-31

All 37 spells with tier tables. Template spells (Force, Mend, Shield, Reveal, Reshape, Sever) were designed in detail in MAGIC_SYSTEM.md §9. This document contains the complete set including those six plus the remaining 31.

**Exhaustion cost formula reference:**

| Complexity | Weak | Standard | Strong | Spectacular |
|-----------|------|----------|--------|-------------|
| 1 | 2 | 4 | 6 | 10 |
| 2 | 3 | 6 | 9 | 14 |
| 3 | 4 | 8 | 12 | 18 |
...
**Fixed casting times:** Each spell has a single casting time regardless of tier. Tier measures how much power the caster draws, not how long it takes. Casting time is a per-spell balancing lever — fast spells can be used reactively but tend to be lower complexity; slow spells require commitment and are vulnerable to interruption. Some spells are **rituals** — they cannot be cast on the timing track and require extended preparation outside combat.
...
**Spell cancellation cost:** Half the Weak tier's exhaustion cost (rounded up), plus 10% chance of backlash. Fixed regardless of what tier might have been achieved.

---

## 1. Aetheric Manipulation

### 1.1 Force
*Complexity: 1 — Casting Time: 2ct*
...
### 1.2 Elemental Manipulation
*Complexity: 2 — Casting Time: 4ct*
...
### 3.4 Circle
*Complexity: 3 — Casting Time: Ritual (30 min)*
...
### 4.2 Scry
*Complexity: 3 — Casting Time: Ritual (10 min)*
...
### 5.6 Transmute
*Complexity: 4 — Casting Time: Ritual (1 hour)*
...
| Spell | School | C | Time | Rationale |
|-------|--------|---|------|-----------|
| Force | Aetheric | 1 | 2ct | Simple raw projection — snap-cast |
| Amplify | Aetheric | 1 | 2ct | Enhancing existing forces — reactive |
| Elemental Manipulation | Aetheric | 2 | 4ct | Shaping/directing specific elements |
| Barrier | Aetheric | 2 | 4ct | Sustained energy construct |
| Kinesis | Aetheric | 2 | 4ct | Controlled remote manipulation |
| Disruption | Aetheric | 2 | 4ct | Targeted unraveling |
| Arc | Aetheric | 2 | 4ct | Routing energy (requires precision) |
| Sense Life | Vivimancy | 1 | 2ct | Passive detection — quick pulse |
| Fortify | Vivimancy | 2 | 4ct | Enhancing existing biology |
| Bloom | Vivimancy | 2 | 4ct | Accelerating natural growth |
| Mend | Vivimancy | 3 | 5ct | Manipulating complex biological systems |
| Wither | Vivimancy | 3 | 5ct | Degrading complex biological systems |
| Purge | Vivimancy | 3 | 6ct | Cleansing intertwined corruption |
| Shape Flesh | Vivimancy | 4 | Ritual (30 min) | Restructuring biology — not combat-castable |
| Shield | Warding | 2 | 3ct | Snap-cast defense — reactive |
| Anchor | Warding | 2 | 3ct | Quick stabilization |
| Unbind | Warding | 2 | 3ct | Counter-warding — needs to be reactive |
| Seal | Warding | 2 | 5ct | Binding/locking — deliberate |
| Banish | Warding | 3 | 6ct | Dispelling/driving out (complex opposition) |
| Circle | Warding | 3 | Ritual (30 min) | Multi-property bounded zone — must be inscribed |
| Detect | Divination | 1 | 2ct | Basic magical sensing — quick pulse |
| Reveal | Divination | 2 | 4ct | Enhanced perception |
| Read | Divination | 2 | 5ct | Psychometry — touch and sense |
| Foresight | Divination | 3 | 6ct | Temporal perception (complex) |
| Commune | Divination | 3 | 6ct | Mental contact across distance |
| Scry | Divination | 3 | Ritual (10 min) | Remote perception — sit-down focus |
| Reshape | Transmutation | 2 | 5ct | Form alteration — deliberate |
| Alter Property | Transmutation | 2 | 5ct | Property manipulation — deliberate |
| Refine | Transmutation | 2 | 5ct | Separation/purification — careful work |
| Fuse | Transmutation | 2 | 5ct | Joining materials — deliberate |
| Enlarge/Reduce | Transmutation | 3 | 6ct | Size change (stresses living systems) |
| Transmute | Transmutation | 4 | Ritual (1 hour) | Substance change — not combat-castable |
| Dampen | Ley Weaving | 3 | 6ct | Suppressing mana flows |
| Channel | Ley Weaving | 3 | 6ct | Redirecting mana flows |
